  ...
  return (
    <div className='bg-white overflow-hidden group rounded-lg cursor-pointer shadow-lg'>
      <div className="relative">
        <Image src={property.imageUrl} alt='property' width={300} height={600} 
        className='w-full object-cover group-hover:scale-100 transition-all duration-300'/>
      <h1 className='px-6 absolute bottom-4 left-4 py-1.5 text-sm bg-black w-fit
      text-white rounded-lg'> 
       <span className='text-base font-bold'>${property.price} </span>/ mo
      </h1>
      <div className="flex items-center space-x-1 px-6 absolute top-4 left-4 py-2 text-sm
      bg-rose-600 w-fit text-white rounded-md">
        <MdElectricBolt/>
        <span>Featured</span>
      </div>
      </div>
      ...
      <div className='flex items-center mt-6 justify-between w-full lg:w-[805]'>
